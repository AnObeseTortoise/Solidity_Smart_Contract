...
contract JointSavings {
    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        */
        require(recipient == accountOne || recipient == accountTwo, "You are not the Owner of the account! ");
        require(contractBalance > 0, "Please fund your account and try again. ");
